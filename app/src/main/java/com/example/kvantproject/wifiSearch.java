...
public class wifiSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.linearLayoutScanResults = this.findViewById(R.id.scrollscanres);
    ...
    class WifiBroadcastReceiver extends BroadcastReceiver  {
        ...
        public void onReceive(Context context, Intent intent)   {
            ...
            Toast.makeText(wifiSearch.this, "Scan Complete!", Toast.LENGTH_SHORT).show();
            ...
            if (ok)  {
                ...
                wifiSearch.this.showNetworks(list);
            }  else {
